  ...
  return (
    <div style={{ background: BG, color: "#F1F5F9", fontFamily: "inherit", minHeight: "100dvh", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", zIndex: 1, maxWidth: 1280, margin: "0 auto", padding: "80px 24px 60px" }}>
        ...
        {/* Stats bar */}
        <div style={{ marginTop: 72, background: DARK_CARD, border: `1px solid ${BORDER}`, borderRadius: 20, padding: "28px 36px", backdropFilter: "blur(16px)" }}>
      ...
      <section style={{ position: "relative", zIndex: 1, overflow: "hidden", maxWidth: 1280, margin: "60px auto 0", padding: "0 24px" }}>
        <div style={{ position: "relative", borderRadius: 24, overflow: "hidden", height: 420 }}>
          ...
          <div style={{ position: "absolute", top: "50%", left: "5%", transform: "translateY(-50%)", maxWidth: 480 }}>
            ...
            <h2 style={{ fontSize: "clamp(22px, 3vw, 38px)", fontWeight: 900, letterSpacing: "-0.02em", lineHeight: 1.15, marginBottom: 16 }}>
            ...
            <button onClick={handleStart}
              style={{ height: 48, borderRadius: 12, fontSize: 14, fontWeight: 700, background: "linear-gradient(135deg, #7C3AED, #4F46E5)", color: "#fff", border: "none", cursor: "pointer", padding: "0 28px", display: "inline-flex", alignItems: "center", gap: 8, boxShadow: "0 8px 32px rgba(124,58,237,0.5)" }}>
              Start Trading Free <ArrowRight size={16} />
            </button>
          </div>

          {/* Live price overlay cards */}
          <div style={{ position: "absolute", right: "4%", top: "50%", transform: "translateY(-50%)", display: "flex", flexDirection: "column", gap: 10 }}>
            {pairs.slice(0, 3).map(p => (
              <div key={p.pair} style={{ background: "rgba(7,9,26,0.85)", border: `1px solid ${p.up ? "rgba(16,185,129,0.3)" : "rgba(239,68,68,0.3)"}`, borderRadius: 12, padding: "10px 14px", backdropFilter: "blur(16px)", minWidth: 160 }}>
      ...
      {/* ── HOW IT WORKS ── */}
      <section style={{ padding: "80px 24px 0", position: "relative", zIndex: 1, maxWidth: 960, margin: "0 auto" }}>
      ...
      {/* ── SECURITY ── */}
      <section style={{ padding: "80px 24px 0", position: "relative", zIndex: 1, maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ background: DARK_CARD, border: `1px solid ${BORDER}`, borderRadius: 24, padding: "44px 40px", backdropFilter: "blur(12px)" }}>
      ...
      {/* ── FINAL CTA ── */}
      <section style={{ padding: "80px 24px 48px", position: "relative", zIndex: 1, maxWidth: 1280, margin: "0 auto" }}>
        <div style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.18) 0%, rgba(79,70,229,0.1) 50%, rgba(7,9,26,0.95) 100%)", border: "1px solid rgba(124,58,237,0.28)", borderRadius: 26, padding: "60px 44px", position: "relative", overflow: "hidden", textAlign: "center" }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .lg\\:grid-cols-4, .lg\\:grid-cols-6 { grid-template-columns: 1fr 1fr !important; }
        }
