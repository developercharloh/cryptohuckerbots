...
const SLIDES = [
  {
    icon: Bot,
    gradient: "linear-gradient(135deg, #F5B942, #D99B18)",
    title: "Smart Trading\nStarts Here",
  ...
  {
    icon: ShieldCheck,
    gradient: "linear-gradient(135deg, #F5B942, #111111)",
    title: "Secure &\nTransparent",
...
function BotVisual() {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "70%", height: "70%" }}>
      ...
      <rect x="88" y="45" width="24" height="22" rx="8" fill="#D99B18" />
      <circle cx="100" cy="34" r="9" fill="#FFD86B" />
      <circle cx="78" cy="98" r="11" fill="#1E1B4B" />
      <circle cx="122" cy="98" r="11" fill="#1E1B4B" />
      <circle cx="78" cy="98" r="5.5" fill="#F5B942" />
      <circle cx="122" cy="98" r="5.5" fill="#F5B942" />
      <circle cx="80" cy="96" r="2" fill="#FFF1B8" />
      <circle cx="124" cy="96" r="2" fill="#FFF1B8" />
      <rect x="84" y="118" width="32" height="8" rx="4" fill="#6B4A0B" />
      <rect x="88" y="120" width="10" height="4" rx="2" fill="#F5B942" />
      ...
      <path d="M70 175 L79 165 L88 175" stroke="#F5B942" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M112 165 L121 175 L130 165" stroke="#F5B942" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <defs>
        <linearGradient id="bh" x1="60" y1="65" x2="140" y2="140" gradientUnits="userSpaceOnUse">
           <stop stopColor="#F5B942" /><stop offset="1" stopColor="#6B4A0B" />
        </linearGradient>
        <linearGradient id="bb" x1="55" y1="148" x2="145" y2="196" gradientUnits="userSpaceOnUse">
           <stop stopColor="#D99B18" /><stop offset="1" stopColor="#111111" />
        </linearGradient>
        ...
        <linearGradient id="bl" x1="70" y1="194" x2="90" y2="216" gradientUnits="userSpaceOnUse">
           <stop stopColor="#F5B942" /><stop offset="1" stopColor="#111111" />
        </linearGradient>
      </defs>
    </svg>
  );
...
function ShieldVisual() {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "70%", height: "70%" }}>
      ...
      <path d="M78 100 L93 115 L125 83" stroke="#FFD86B" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <defs>
        ...
        <linearGradient id="si" x1="48" y1="28" x2="152" y2="172" gradientUnits="userSpaceOnUse">
           <stop stopColor="#FFD86B" stopOpacity="0.4" /><stop offset="1" stopColor="#F5B942" stopOpacity="0" />
        </linearGradient>
      </defs>
    </svg>
  );
...
export default function Onboarding() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100dvh", background: "linear-gradient(160deg, #070707 0%, #17130A 60%, #070707 100%)", padding: "0 24px", position: "relative", overflow: "hidden" }}>

      {/* Glow */}
       <div style={{ position: "absolute", top: "10%", left: "50%", transform: "translateX(-50%)", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(245,185,66,0.2) 0%, transparent 70%)", pointerEvents: "none" }} />
            ...
            <div
              ...
              style={{
                ...
                width: i === current ? 24 : 8,
                 background: i === current ? "linear-gradient(90deg, #F5B942, #FFD86B)" : "rgba(255,255,255,0.12)",
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginBottom: 32 }}>
          <div style={{ position: "relative", width: 220, height: 220, display: "flex", alignItems: "center", justifyContent: "center" }}>
             <div style={{ position: "absolute", inset: 0, borderRadius: "50%", background: "radial-gradient(circle, rgba(245,185,66,0.25) 0%, transparent 70%)", animation: "breathe 3s ease-in-out infinite" }} />
             <div style={{ position: "absolute", inset: 16, borderRadius: "50%", border: "1px solid rgba(245,185,66,0.2)" }} />
             <div style={{ position: "absolute", inset: 32, borderRadius: "50%", border: "1px solid rgba(245,185,66,0.12)" }} />
            {current === 0 && <BotVisual />}
        ...
        <button
          ...
          style={{
            ...
            color: "#fff", border: "none", cursor: "pointer",
             boxShadow: "0 8px 28px rgba(245,185,66,0.35)",
          }}
        >
