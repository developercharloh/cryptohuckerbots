 ...
 */
export const getMarketQuote = async (params: GetMarketQuoteParams, options?: RequestInit): Promise<MarketQuote> => {
...
export const getGetMarketQuoteQueryOptions = <TData = Awaited<ReturnType<typeof getMarketQuote>>, TError = ErrorType<ErrorResponse>>(params: GetMarketQuoteParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMarketQuote>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetMarketQuoteQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMarketQuote>>> = ({ signal }) => getMarketQuote(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMarketQuote>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetMarketQuote<TData = Awaited<ReturnType<typeof getMarketQuote>>, TError = ErrorType<ErrorResponse>>(
 params: GetMarketQuoteParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getMarketQuote>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const verifyEmail = async (params: VerifyEmailParams, options?: RequestInit): Promise<VerifyEmail200> => {

  return customFetch<VerifyEmail200>(getVerifyEmailUrl(params),
  {
    ...options,
    method: 'GET'
...
export const resendVerification = async (forgotPasswordInput: ForgotPasswordInput, options?: RequestInit): Promise<SuccessResponse> => {
...
export const getResendVerificationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resendVerification>>, TError,{data: BodyType<ForgotPasswordInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof resendVerification>>, TError,{data: BodyType<ForgotPasswordInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resendVerification>>, {data: BodyType<ForgotPasswordInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResendVerificationMutationBody = BodyType<ForgotPasswordInput>
...
export const getVerifyLoginOtpMutationOptions = <TError = ErrorType<ErrorResponse>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type VerifyLoginOtpMutationError = ErrorType<ErrorResponse>

    export const useVerifyLoginOtp = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyLoginOtp>>, TError,{data: BodyType<VerifyLoginOtpInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getResendLoginOtpUrl = () => {
  ...
  return `/api/auth/login/otp/resend`
}

export const resendLoginOtp = async (resendLoginOtpInput: ResendLoginOtpInput, options?: RequestInit): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getResendLoginOtpUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetBotAnalyticsQueryKey(id,period);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined && period !== null && period !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBotAnalytics>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDepositSessionQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDepositSession>>, TError, TData> & { queryKey: QueryKey }
}
...
export const submitDepositTxid = async (id: number,
  ...
  return customFetch<DepositSession>(getSubmitDepositTxidUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(submitTxidInput)
  }
);}
...
export const adminReviewDepositSession = async (id: number,
  ...
  return customFetch<AdminDepositSession>(getAdminReviewDepositSessionUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminReviewDepositInput)
  }
);}
...
export const toggle2FA = async (twoFAToggleInput: TwoFAToggleInput, options?: RequestInit): Promise<TwoFAStatus> => {
  ...
  return customFetch<TwoFAStatus>(getToggle2FAUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(twoFAToggleInput)
  }
);}
...
export const createKycSession = async (kYCSessionInput: KYCSessionInput, options?: RequestInit): Promise<KYCSession> => {
  ...
  return customFetch<KYCSession>(getCreateKycSessionUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(kYCSessionInput)
  }
);}
...
export const adminAdjustBalance = async (id: number,
  ...
  return customFetch<AdminUser>(getAdminAdjustBalanceUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminBalanceAdjustInput)
  }
);}
...
export const adminRefundByUid = async (adminRefundByUidInput: AdminRefundByUidInput, options?: RequestInit): Promise<AdminUser> => {
  ...
  return customFetch<AdminUser>(getAdminRefundByUidUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminRefundByUidInput)
  }
);}
...
export const adminReviewKyc = async (userId: number,
  ...
  return customFetch<AdminKycItem>(getAdminReviewKycUrl(userId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminKycReviewInput)
  }
);}
...
export const adminCreateBot = async (adminBotInput: AdminBotInput, options?: RequestInit): Promise<AdminBot> => {
  ...
  return customFetch<AdminBot>(getAdminCreateBotUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminBotInput)
  }
);}
...
export const adminUpdateBot = async (id: number,
  ...
  return customFetch<AdminBot>(getAdminUpdateBotUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminBotUpdate)
  }
);}
...
export const adminAssignBot = async (id: number,
  ...
  return customFetch<SuccessResponse>(getAdminAssignBotUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminAssignBotInput)
  }
);}
...
export const adminListReferrals = async ( options?: RequestInit): Promise<AdminReferral[]> => {

  return customFetch<AdminReferral[]>(getAdminListReferralsUrl(),
  {
    ...options,
    method: 'GET'
...
export const adminReviewTransaction = async (id: number,
  ...
  return customFetch<AdminTransaction>(getAdminReviewTransactionUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminTxnReviewInput)
  }
);}
...
export const adminReplyTicket = async (id: number,
  ...
  return customFetch<AdminTicket>(getAdminReplyTicketUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminTicketReplyInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAdminGetChatQueryKey(userId);
   ...
   return  { queryKey, queryFn, enabled: userId !== null && userId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminGetChat>>, TError, TData> & { queryKey: QueryKey }
}
